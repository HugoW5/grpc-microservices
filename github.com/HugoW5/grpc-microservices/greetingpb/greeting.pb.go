...
const file_proto_greeting_proto_rawDesc = "" +
	...
	"\x0fGreetingService\x12A\n" +
	"\bSayHello\x12\x19.greeting.SayHelloRequest\x1a\x1a.greeting.SayHelloResponseB1Z/github.com/HugoW5/grpc-microservices/greetingpbb\x06proto3"
...
var file_proto_greeting_proto_goTypes = []any{
	(*SayHelloRequest)(nil),  // 0: greeting.SayHelloRequest
	(*SayHelloResponse)(nil), // 1: greeting.SayHelloResponse
}
var file_proto_greeting_proto_depIdxs = []int32{
	0, // 0: greeting.GreetingService.SayHello:input_type -> greeting.SayHelloRequest
	1, // 1: greeting.GreetingService.SayHello:output_type -> greeting.SayHelloResponse
